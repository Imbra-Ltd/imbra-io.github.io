...
7. Contact — dark (`#111318`) section: headline naming the buyer's problem as a question, short sub (`set:html`, links to pricing), the form as the primary action, and the email address as a labelled alternative beneath it
